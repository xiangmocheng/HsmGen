...
stMenuEntryInfo MEntry_Copy_2Pages = { MID_Copy_2Pages, SID_2Pages, QUAL_TYPE, 0, 1, 0, 0, 0, 0, 0};
stMenuEntryInfo MEntry_Copy_4Pages = { MID_Copy_4Pages, SID_4Pages, QUAL_TYPE, 0, 2, 0, 0, 0, 0, 0};
